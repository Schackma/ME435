...
scriptCommand(handles.user.serial,'RESET');
...
x_axis_popup;
set(x_axis_popup,'UserData',handles.user.serial);
...
z_axis_popup;
set(z_axis_popup,'UserData',handles.user.serial);
...
gripper_popup;
set(gripper_popup,'UserData',handles.user.serial);
...
fprintf('move pushed\n');
move_popup;
set(move_popup,'UserData',handles.user.serial);
